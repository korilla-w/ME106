...
lv_style_t me106_theme_light_energy_capacitive_reactive;
lv_style_t me106_theme_alarm_energy_forward_active;
lv_style_t me106_theme_alarm_energy_reverse_active;
lv_style_t me106_theme_alarm_energy_inductive_reactive;
lv_style_t me106_theme_alarm_energy_capacitive_reactive;
...
lv_style_t me106_text_16_purple;
...
void power_meter_ui_init_gen(const char * asset_path)
{
    ...
    lv_subject_set_max_value_int(&meter_settings_selected_index, 10);
    ...
    lv_subject_init_int(&meter_screen_timeout_index, 0);
    lv_subject_set_min_value_int(&meter_screen_timeout_index, 0);
    lv_subject_set_max_value_int(&meter_screen_timeout_index, 4);
    ...
    lv_subject_init_int(&meter_alarm_threshold_lost_volt_value, 5000);
    ...
    lv_subject_init_int(&meter_alarm_threshold_sagcfg_value, 180);
    lv_subject_set_min_value_int(&meter_alarm_threshold_sagcfg_value, 0);
    lv_subject_set_max_value_int(&meter_alarm_threshold_sagcfg_value, 500);
    lv_subject_init_int(&meter_alarm_threshold_ovlvl_value, 260);
    lv_subject_set_min_value_int(&meter_alarm_threshold_ovlvl_value, 0);
    lv_subject_set_max_value_int(&meter_alarm_threshold_ovlvl_value, 500);
    lv_subject_init_int(&meter_alarm_threshold_oilvl_value, 5);
    lv_subject_set_min_value_int(&meter_alarm_threshold_oilvl_value, 0);
    lv_subject_set_max_value_int(&meter_alarm_threshold_oilvl_value, 500);
    ...
    lv_subject_init_int(&meter_energy_forward_active_issue, 1);
    ...
    lv_subject_init_int(&meter_energy_reverse_active_issue, 1);
    ...
    lv_subject_init_int(&meter_energy_inductive_reactive_issue, 1);
    ...
    lv_subject_init_int(&meter_energy_capacitive_reactive_issue, 1);
    ...
    lv_subject_init_int(&meter_phase_a_current_angle_issue, 1);
    ...
    lv_subject_init_int(&meter_phase_b_current_angle_issue, 1);
    ...
    lv_subject_init_int(&meter_phase_c_current_angle_issue, 1);
    ...
    lv_subject_init_int(&meter_phase_c_voltage_angle_issue, 1);
