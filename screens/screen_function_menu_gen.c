...
lv_obj_t * screen_function_menu_create(void)
{
    ...
    lv_obj_t * lv_label_2 = lv_label_create(function_item_harmonic_lock);
    lv_label_set_text(lv_label_2, "LOCK");
    ...
    lv_obj_add_style(lv_label_2, &me106_text_14_white, 0);
    ...
    lv_obj_t * lv_label_5 = lv_label_create(function_item_waveform_lock);
    lv_label_set_text(lv_label_5, "LOCK");
    lv_obj_set_align(lv_label_5, LV_ALIGN_RIGHT_MID);
    lv_obj_set_x(lv_label_5, -28);
    lv_obj_set_y(lv_label_5, 0);
    lv_obj_set_width(lv_label_5, 42);
    lv_obj_add_style(lv_label_5, &me106_text_14_white, 0);
    ...
    lv_obj_bind_style(lv_label_6, &me106_text_16_white, 0, &meter_function_menu_selected_index, 2);

    lv_obj_t * lv_label_7 = lv_label_create(function_item_quality);
    lv_label_set_text(lv_label_7, "›");
    lv_obj_set_align(lv_label_7, LV_ALIGN_RIGHT_MID);
    lv_obj_set_x(lv_label_7, -14);
    lv_obj_set_y(lv_label_7, -1);
    lv_obj_set_width(lv_label_7, 14);
