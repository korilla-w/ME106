...
lv_obj_t * screen_function_menu_create(void)
{
    ...
    if (power_meter_ui_check_target(POWER_METER_UI_TARGET_ALL)) {
        ...
        lv_obj_bind_style(lv_image_0, &me106_icon_white, 0, &meter_function_menu_selected_index, 0);
        ...
        lv_obj_t * lv_image_1 = lv_image_create(function_item_harmonic);
        ...
        lv_obj_bind_style(lv_image_1, &me106_icon_white, 0, &meter_function_menu_selected_index, 0);

        lv_obj_t * function_item_harmonic_lock = lv_button_create(function_item_harmonic);
        lv_obj_set_name(function_item_harmonic_lock, "function_item_harmonic_lock");
        lv_obj_set_x(function_item_harmonic_lock, 0);
        lv_obj_set_y(function_item_harmonic_lock, 0);
        lv_obj_set_width(function_item_harmonic_lock, 270);
        lv_obj_set_height(function_item_harmonic_lock, 40);
        lv_obj_set_style_bg_opa(function_item_harmonic_lock, 0, 0);
        lv_obj_set_style_border_width(function_item_harmonic_lock, 0, 0);
        lv_obj_set_style_shadow_width(function_item_harmonic_lock, 0, 0);
        lv_obj_set_style_pad_all(function_item_harmonic_lock, 0, 0);
        lv_obj_set_flag(function_item_harmonic_lock, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_bind_flag_if_not_eq(function_item_harmonic_lock, &meter_feature_harmonics_locked, LV_OBJ_FLAG_HIDDEN, 1);
        lv_obj_add_subject_set_int_event(function_item_harmonic_lock, &meter_function_menu_special_action, LV_EVENT_CLICKED, 1);
        lv_obj_t * lv_label_1 = lv_label_create(function_item_harmonic_lock);
        lv_label_set_text(lv_label_1, "LOCK");
        lv_obj_set_align(lv_label_1, LV_ALIGN_RIGHT_MID);
        lv_obj_set_x(lv_label_1, -28);
        lv_obj_set_y(lv_label_1, 0);
        lv_obj_set_width(lv_label_1, 42);
        lv_obj_add_style(lv_label_1, &me106_text_14_white, 0);
        ...
        lv_obj_bind_style(lv_label_1, &me106_text_14_white, 0, &meter_function_menu_selected_index, 0);
        ...
        lv_obj_bind_style(lv_image_2, &me106_icon_white, 0, &meter_function_menu_selected_index, 1);
        ...
        lv_obj_t * lv_image_3 = lv_image_create(function_item_waveform);
        ...
        lv_obj_bind_style(lv_image_3, &me106_icon_white, 0, &meter_function_menu_selected_index, 1);

        lv_obj_t * function_item_waveform_lock = lv_button_create(function_item_waveform);
        lv_obj_set_name(function_item_waveform_lock, "function_item_waveform_lock");
        lv_obj_set_x(function_item_waveform_lock, 0);
        lv_obj_set_y(function_item_waveform_lock, 0);
        lv_obj_set_width(function_item_waveform_lock, 270);
        lv_obj_set_height(function_item_waveform_lock, 40);
        lv_obj_set_style_bg_opa(function_item_waveform_lock, 0, 0);
        lv_obj_set_style_border_width(function_item_waveform_lock, 0, 0);
        lv_obj_set_style_shadow_width(function_item_waveform_lock, 0, 0);
        lv_obj_set_style_pad_all(function_item_waveform_lock, 0, 0);
        lv_obj_set_flag(function_item_waveform_lock, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_bind_flag_if_not_eq(function_item_waveform_lock, &meter_feature_harmonics_locked, LV_OBJ_FLAG_HIDDEN, 1);
        lv_obj_add_subject_set_int_event(function_item_waveform_lock, &meter_function_menu_special_action, LV_EVENT_CLICKED, 1);
        lv_obj_t * lv_label_3 = lv_label_create(function_item_waveform_lock);
        lv_label_set_text(lv_label_3, "LOCK");
        lv_obj_set_align(lv_label_3, LV_ALIGN_RIGHT_MID);
        lv_obj_set_x(lv_label_3, -28);
        lv_obj_set_y(lv_label_3, 0);
        lv_obj_set_width(lv_label_3, 42);
        lv_obj_add_style(lv_label_3, &me106_text_14_white, 0);
        ...
        lv_obj_bind_style(lv_label_3, &me106_text_14_white, 0, &meter_function_menu_selected_index, 1);
        ...
        lv_obj_t * lv_image_4 = lv_image_create(function_item_quality);
        lv_image_set_src(lv_image_4, meter_icon_electric_energy);
        lv_obj_set_align(lv_image_4, LV_ALIGN_LEFT_MID);
        lv_obj_set_x(lv_image_4, 13);
        ...
        lv_obj_bind_style(lv_image_4, &me106_icon_white, 0, &meter_function_menu_selected_index, 2);
        ...
        lv_obj_t * lv_image_5 = lv_image_create(function_item_quality);
        ...
        lv_obj_add_style(lv_image_5, &me106_icon_white, 0);
        lv_obj_bind_style(lv_image_5, &me106_theme_light_icon, 0, &meter_theme_index, 1);
        lv_obj_bind_style(lv_image_5, &me106_theme_alarm_icon, 0, &meter_theme_index, 2);
        lv_obj_bind_style(lv_image_5, &me106_icon_white, 0, &meter_function_menu_selected_index, 2);
        ...
        lv_obj_t * lv_image_6 = lv_image_create(function_btn_return);
        lv_image_set_src(lv_image_6, meter_icon_return);
        lv_obj_set_align(lv_image_6, LV_ALIGN_CENTER);
        lv_obj_set_style_transform_pivot_x(lv_image_6, 8, 0);
        lv_obj_set_style_transform_pivot_y(lv_image_6, 7, 0);
        lv_obj_set_style_transform_scale_x(lv_image_6, 230, 0);
        lv_obj_set_style_transform_scale_y(lv_image_6, 230, 0);

        lv_obj_add_screen_create_event(function_btn_return, LV_EVENT_CLICKED, screen_home_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
        ...
        lv_obj_t * lv_image_7 = lv_image_create(function_btn_down);
        lv_image_set_src(lv_image_7, meter_arrow_down);
        lv_obj_set_align(lv_image_7, LV_ALIGN_CENTER);
        lv_obj_set_style_transform_pivot_x(lv_image_7, 7, 0);
        lv_obj_set_style_transform_pivot_y(lv_image_7, 5, 0);
        ...
        lv_obj_t * lv_image_8 = lv_image_create(function_btn_up);
        lv_image_set_src(lv_image_8, meter_arrow_up);
        lv_obj_set_align(lv_image_8, LV_ALIGN_CENTER);
        lv_obj_set_style_transform_pivot_x(lv_image_8, 7, 0);
        lv_obj_set_style_transform_pivot_y(lv_image_8, 5, 0);
        lv_obj_set_style_transform_scale_x(lv_image_8, 230, 0);
        lv_obj_set_style_transform_scale_y(lv_image_8, 230, 0);
        ...
        lv_obj_t * lv_image_9 = lv_image_create(function_btn_yes);
        lv_image_set_src(lv_image_9, meter_yes);
        lv_obj_set_align(lv_image_9, LV_ALIGN_CENTER);
        lv_obj_set_style_transform_pivot_x(lv_image_9, 9, 0);
        lv_obj_set_style_transform_pivot_y(lv_image_9, 6, 0);
        lv_obj_set_style_transform_scale_x(lv_image_9, 230, 0);
        lv_obj_set_style_transform_scale_y(lv_image_9, 230, 0);
        ...
        lv_obj_t * function_btn_yes_harmonic_lock = lv_button_create(function_btn_yes_harmonic);
        lv_obj_set_name(function_btn_yes_harmonic_lock, "function_btn_yes_harmonic_lock");
        lv_obj_set_x(function_btn_yes_harmonic_lock, 0);
        lv_obj_set_y(function_btn_yes_harmonic_lock, 0);
        lv_obj_set_width(function_btn_yes_harmonic_lock, 80);
        lv_obj_set_height(function_btn_yes_harmonic_lock, 32);
        lv_obj_set_style_bg_opa(function_btn_yes_harmonic_lock, 0, 0);
        lv_obj_set_style_border_width(function_btn_yes_harmonic_lock, 0, 0);
        lv_obj_set_style_shadow_width(function_btn_yes_harmonic_lock, 0, 0);
        lv_obj_set_style_pad_all(function_btn_yes_harmonic_lock, 0, 0);
        lv_obj_set_flag(function_btn_yes_harmonic_lock, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_bind_flag_if_not_eq(function_btn_yes_harmonic_lock, &meter_feature_harmonics_locked, LV_OBJ_FLAG_HIDDEN, 1);
        lv_obj_add_subject_set_int_event(function_btn_yes_harmonic_lock, &meter_function_menu_special_action, LV_EVENT_CLICKED, 1);
        ...
        lv_obj_t * function_btn_yes_waveform_lock = lv_button_create(function_btn_yes_waveform);
        lv_obj_set_name(function_btn_yes_waveform_lock, "function_btn_yes_waveform_lock");
        lv_obj_set_x(function_btn_yes_waveform_lock, 0);
        lv_obj_set_y(function_btn_yes_waveform_lock, 0);
        lv_obj_set_width(function_btn_yes_waveform_lock, 80);
        lv_obj_set_height(function_btn_yes_waveform_lock, 32);
        lv_obj_set_style_bg_opa(function_btn_yes_waveform_lock, 0, 0);
        lv_obj_set_style_border_width(function_btn_yes_waveform_lock, 0, 0);
        lv_obj_set_style_shadow_width(function_btn_yes_waveform_lock, 0, 0);
        lv_obj_set_style_pad_all(function_btn_yes_waveform_lock, 0, 0);
        lv_obj_set_flag(function_btn_yes_waveform_lock, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_bind_flag_if_not_eq(function_btn_yes_waveform_lock, &meter_feature_harmonics_locked, LV_OBJ_FLAG_HIDDEN, 1);
        lv_obj_add_subject_set_int_event(function_btn_yes_waveform_lock, &meter_function_menu_special_action, LV_EVENT_CLICKED, 1);
