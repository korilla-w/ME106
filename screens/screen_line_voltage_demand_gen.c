...
lv_obj_t * screen_line_voltage_demand_create(void)
{
    ...
    lv_obj_set_x(line_ab_voltage_issue, 60);
    lv_obj_set_y(line_ab_voltage_issue, 55);
    lv_obj_set_width(line_ab_voltage_issue, 12);
    lv_obj_set_height(line_ab_voltage_issue, 12);
    ...
    lv_obj_set_x(line_bc_voltage_issue, 159);
    lv_obj_set_y(line_bc_voltage_issue, 55);
    lv_obj_set_width(line_bc_voltage_issue, 12);
    lv_obj_set_height(line_bc_voltage_issue, 12);
    ...
    lv_obj_set_x(line_ca_voltage_issue, 258);
    lv_obj_set_y(line_ca_voltage_issue, 55);
    lv_obj_set_width(line_ca_voltage_issue, 12);
    lv_obj_set_height(line_ca_voltage_issue, 12);
    ...
    lv_obj_set_y(line_current_demand_issue, 120);
    lv_obj_set_width(line_current_demand_issue, 12);
    lv_obj_set_height(line_current_demand_issue, 12);
    ...
    lv_obj_set_y(line_max_demand_issue, 120);
    lv_obj_set_width(line_max_demand_issue, 12);
    lv_obj_set_height(line_max_demand_issue, 12);
