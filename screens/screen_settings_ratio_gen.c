...
lv_obj_t * screen_settings_ratio_create(void)
{
    ...
    if (power_meter_ui_check_target(POWER_METER_UI_TARGET_ALL)) {
        ...
        lv_obj_add_style(ratio_ct_digit_0_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_ct_digit_0_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_ct_digit_0_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_ct_digit_1_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_ct_digit_1_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_ct_digit_1_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_ct_digit_2_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_ct_digit_2_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_ct_digit_2_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_ct_digit_3_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_ct_digit_3_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_ct_digit_3_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_pt_digit_0_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_pt_digit_0_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_pt_digit_0_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_pt_digit_1_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_pt_digit_1_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_pt_digit_1_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_pt_digit_2_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_pt_digit_2_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_pt_digit_2_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_style(ratio_pt_digit_3_slot, &me106_theme_dark_digit_slot, 0);
        lv_obj_bind_style(ratio_pt_digit_3_slot, &me106_theme_light_digit_slot, 0, &meter_theme_index, 1);
        lv_obj_bind_style(ratio_pt_digit_3_slot, &me106_theme_alarm_digit_slot, 0, &meter_theme_index, 2);
        ...
        lv_obj_add_screen_create_event(ratio_btn_return, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_OUT, 105, 0);
        ...
        lv_obj_add_screen_create_event(ratio_btn_yes_ct, LV_EVENT_CLICKED, screen_settings_ratio_ct_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
        ...
        lv_obj_add_screen_create_event(ratio_btn_yes_pt, LV_EVENT_CLICKED, screen_settings_ratio_pt_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
