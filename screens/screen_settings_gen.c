...
lv_obj_t * screen_settings_create(void)
{
    ...
    lv_obj_set_height(settings_items, 454);
    ...
    lv_obj_bind_style(settings_items, &me106_move_y_n24, 0, &meter_settings_selected_index, 3);
    lv_obj_bind_style(settings_items, &me106_move_y_n70, 0, &meter_settings_selected_index, 4);
    lv_obj_bind_style(settings_items, &me106_move_y_n116, 0, &meter_settings_selected_index, 5);
    lv_obj_bind_style(settings_items, &me106_move_y_n162, 0, &meter_settings_selected_index, 6);
    lv_obj_bind_style(settings_items, &me106_move_y_n208, 0, &meter_settings_selected_index, 7);
    lv_obj_bind_style(settings_items, &me106_move_y_n254, 0, &meter_settings_selected_index, 8);
    lv_obj_bind_style(settings_items, &me106_move_y_n300, 0, &meter_settings_selected_index, 9);
    ...
    lv_obj_set_y(settings_item_factory, 322);
    ...
    lv_obj_bind_flag_if_not_eq(settings_item_factory_selected_bg, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 7);
    
    lv_obj_t * lv_image_14 = lv_image_create(settings_item_factory);
    lv_image_set_src(lv_image_14, meter_icon_restart);
    lv_obj_set_align(lv_image_14, LV_ALIGN_LEFT_MID);
    lv_obj_set_x(lv_image_14, 12);
    ...
    lv_obj_t * lv_image_15 = lv_image_create(settings_item_factory);
    ...
    lv_obj_set_y(settings_item_upgrade, 368);
    ...
    lv_obj_bind_flag_if_not_eq(settings_item_upgrade_selected_bg, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 8);
    
    lv_obj_t * lv_image_16 = lv_image_create(settings_item_upgrade);
    lv_image_set_src(lv_image_16, meter_icon_update);
    ...
    lv_obj_t * lv_image_17 = lv_image_create(settings_item_upgrade);
    ...
    lv_obj_set_y(settings_item_system, 414);
    ...
    lv_obj_bind_flag_if_not_eq(settings_item_system_selected_bg, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 9);
    
    lv_obj_t * lv_image_18 = lv_image_create(settings_item_system);
    lv_image_set_src(lv_image_18, meter_icon_information);
    ...
    lv_obj_t * lv_image_19 = lv_image_create(settings_item_system);
    ...
    lv_obj_t * lv_image_20 = lv_image_create(settings_btn_return);
    lv_image_set_src(lv_image_20, meter_icon_return);
    lv_obj_set_align(lv_image_20, LV_ALIGN_CENTER);
    lv_obj_set_style_transform_pivot_x(lv_image_20, 8, 0);
    lv_obj_set_style_transform_pivot_y(lv_image_20, 7, 0);
    lv_obj_set_style_transform_scale_x(lv_image_20, 230, 0);
    lv_obj_set_style_transform_scale_y(lv_image_20, 230, 0);
    ...
    lv_obj_t * lv_image_21 = lv_image_create(settings_btn_down);
    lv_image_set_src(lv_image_21, meter_arrow_down);
    lv_obj_set_align(lv_image_21, LV_ALIGN_CENTER);
    lv_obj_set_style_transform_pivot_x(lv_image_21, 7, 0);
    lv_obj_set_style_transform_pivot_y(lv_image_21, 5, 0);
    lv_obj_set_style_transform_scale_x(lv_image_21, 230, 0);
    lv_obj_set_style_transform_scale_y(lv_image_21, 230, 0);
    ...
    lv_obj_set_subject_increment_event_max_value(settings_btn_down, subject_increment_event_0, 9);
    ...
    lv_obj_t * lv_image_22 = lv_image_create(settings_btn_up);
    lv_image_set_src(lv_image_22, meter_arrow_up);
    lv_obj_set_align(lv_image_22, LV_ALIGN_CENTER);
    lv_obj_set_style_transform_pivot_x(lv_image_22, 7, 0);
    lv_obj_set_style_transform_pivot_y(lv_image_22, 5, 0);
    ...
    lv_obj_set_subject_increment_event_max_value(settings_btn_up, subject_increment_event_1, 9);
    ...
    lv_obj_t * lv_image_23 = lv_image_create(settings_btn_yes);
    lv_image_set_src(lv_image_23, meter_yes);
    lv_obj_set_align(lv_image_23, LV_ALIGN_CENTER);
    lv_obj_set_style_transform_pivot_x(lv_image_23, 9, 0);
    lv_obj_set_style_transform_pivot_y(lv_image_23, 6, 0);
    ...
    lv_obj_bind_flag_if_not_eq(settings_btn_yes_factory, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 7);
    ...
    lv_obj_bind_flag_if_not_eq(settings_btn_yes_upgrade, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 8);
    ...
    lv_obj_bind_flag_if_not_eq(settings_btn_yes_system, &meter_settings_selected_index, LV_OBJ_FLAG_HIDDEN, 9);
