...
lv_obj_t * screen_active_power_create(void)
{
    ...
    lv_obj_set_width(active_a_power_issue, 12);
    lv_obj_set_height(active_a_power_issue, 12);
    ...
    lv_obj_set_width(active_b_power_issue, 12);
    lv_obj_set_height(active_b_power_issue, 12);
    ...
    lv_obj_set_width(active_c_power_issue, 12);
    lv_obj_set_height(active_c_power_issue, 12);
    ...
    lv_obj_set_width(active_total_power_issue, 12);
    lv_obj_set_height(active_total_power_issue, 12);
