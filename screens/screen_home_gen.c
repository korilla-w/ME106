...
lv_obj_t * screen_home_create(void)
{
    ...
    if (power_meter_ui_check_target(POWER_METER_UI_TARGET_ALL)) {
        ...
        lv_obj_t * home_header = lv_obj_create(page_content);
        lv_obj_set_name(home_header, "home_header");
        lv_obj_set_x(home_header, 0);
        lv_obj_set_y(home_header, 0);
        lv_obj_set_width(home_header, 320);
        lv_obj_set_height(home_header, 44);
        lv_obj_set_style_bg_opa(home_header, 0, 0);
        lv_obj_set_style_border_width(home_header, 0, 0);
        lv_obj_set_style_pad_all(home_header, 0, 0);
        lv_obj_set_flag(home_header, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_t * home_brand = lv_obj_create(home_header);
        ...
        lv_obj_t * lv_label_0 = lv_label_create(home_header);
        ...
        lv_label_set_text(lv_label_5, "0.000");
        ...
        lv_label_set_text(lv_label_6, "0.0000");
        ...
        lv_label_set_text(lv_label_7, "0.000");
        ...
        lv_obj_set_x(home_a_voltage_issue, 128);
        ...
        lv_obj_set_x(home_a_current_issue, 211);
        ...
        lv_obj_set_x(home_a_pf_issue, 301);
        ...
        lv_label_set_text(lv_label_13, "0.0000");
        ...
        lv_obj_set_x(home_b_voltage_issue, 128);
        ...
        lv_obj_set_x(home_b_current_issue, 211);
        ...
        lv_obj_set_x(home_b_pf_issue, 301);
        ...
        lv_label_set_text(lv_label_19, "0.000");
        ...
        lv_label_set_text(lv_label_20, "0.0000");
        ...
        lv_obj_set_x(home_c_voltage_issue, 128);
        ...
        lv_obj_set_x(home_c_current_issue, 211);
        ...
        lv_obj_set_x(home_c_pf_issue, 301);
        ...
        lv_obj_add_screen_create_event(home_btn_settings, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
        ...
        lv_obj_add_screen_create_event(home_btn_reserved, LV_EVENT_CLICKED, screen_function_menu_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
