...
lv_obj_t * screen_reactive_power_create(void)
{
    ...
    lv_obj_set_width(reactive_a_power_issue, 12);
    lv_obj_set_height(reactive_a_power_issue, 12);
    ...
    lv_obj_set_width(reactive_b_power_issue, 12);
    lv_obj_set_height(reactive_b_power_issue, 12);
    ...
    lv_obj_set_width(reactive_c_power_issue, 12);
    lv_obj_set_height(reactive_c_power_issue, 12);
    ...
    lv_obj_set_width(reactive_total_power_issue, 12);
    lv_obj_set_height(reactive_total_power_issue, 12);
    ...
    lv_obj_add_screen_create_event(reactive_btn_settings, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 120, 0);
    ...
    lv_obj_add_screen_create_event(reactive_btn_reserved, LV_EVENT_CLICKED, screen_function_menu_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 120, 0);
    ...
    at_array[SCREEN_REACTIVE_POWER_TIMELINE_CONTENT_OPEN] = timeline_content_open_create(lv_obj_0);
    lv_obj_set_user_data(lv_obj_0, at_array);
    lv_obj_add_event_cb(lv_obj_0, free_timeline_event_cb, LV_EVENT_DELETE, at_array);

    lv_obj_add_play_timeline_event(lv_obj_0, LV_EVENT_SCREEN_LOADED, screen_reactive_power_get_timeline(lv_obj_0, SCREEN_REACTIVE_POWER_TIMELINE_CONTENT_OPEN), 0, false);
