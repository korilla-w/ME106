...
typedef enum {
    SCREEN_BOOT_TIMELINE_BOOT_INTRO = 0,
    _SCREEN_BOOT_TIMELINE_CNT = 1
}screen_boot_timeline_t;
...
/**
 * Get a timeline of a screen_boot
 * @param obj          pointer to a screen_boot component
