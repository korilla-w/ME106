...
lv_obj_t * screen_settings_factory_reset_create(void)
{
    ...
    lv_obj_add_screen_create_event(factory_btn_return, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_OUT, 105, 0);
    ...
    lv_obj_add_screen_create_event(factory_btn_yes_cancel, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_OUT, 105, 0);
    ...
    lv_obj_add_screen_create_event(factory_btn_yes_confirm, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_OUT, 105, 0);
