/**
 * @file screen_harmonic_spectrum_table_current_6_gen.c
...
#include "screen_harmonic_spectrum_table_current_6_gen.h"
...
lv_obj_t * screen_harmonic_spectrum_table_current_6_create(void)
{
    ...
    lv_obj_set_name_static(lv_obj_0, "screen_harmonic_spectrum_table_current_6_#");
    ...
    lv_label_set_text(lv_label_9, "0.01");
    ...
    lv_label_set_text(lv_label_21, "0.00");
    ...
    lv_label_set_text(lv_label_30, "0.03");
    ...
    lv_label_set_text(lv_label_38, "0.04");
    ...
    lv_obj_t * screen_harmonic_spectrum_table_current_6_bottom_bar = lv_obj_create(lv_obj_0);
    lv_obj_set_name(screen_harmonic_spectrum_table_current_6_bottom_bar, "screen_harmonic_spectrum_table_current_6_bottom_bar");
    lv_obj_set_x(screen_harmonic_spectrum_table_current_6_bottom_bar, 0);
    lv_obj_set_y(screen_harmonic_spectrum_table_current_6_bottom_bar, 207);
    lv_obj_set_width(screen_harmonic_spectrum_table_current_6_bottom_bar, 320);
    lv_obj_set_height(screen_harmonic_spectrum_table_current_6_bottom_bar, 33);
    lv_obj_set_style_border_width(screen_harmonic_spectrum_table_current_6_bottom_bar, 0, 0);
    lv_obj_set_style_pad_all(screen_harmonic_spectrum_table_current_6_bottom_bar, 0, 0);
    lv_obj_set_flag(screen_harmonic_spectrum_table_current_6_bottom_bar, LV_OBJ_FLAG_SCROLLABLE, false);
    lv_obj_add_style(screen_harmonic_spectrum_table_current_6_bottom_bar, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(screen_harmonic_spectrum_table_current_6_bottom_bar, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(screen_harmonic_spectrum_table_current_6_bottom_bar, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    ...
    lv_obj_add_screen_create_event(spectrum_table_btn_down, LV_EVENT_CLICKED, screen_harmonic_spectrum_table_current_7_create, LV_SCREEN_LOAD_ANIM_NONE, 0, 0);
    ...
    lv_obj_add_screen_create_event(spectrum_table_btn_up, LV_EVENT_CLICKED, screen_harmonic_spectrum_table_current_5_create, LV_SCREEN_LOAD_ANIM_NONE, 0, 0);
