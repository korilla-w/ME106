/**
 * @file screen_power_quality_analysis_gen.h
 */

#ifndef SCREEN_POWER_QUALITY_ANALYSIS_H
#define SCREEN_POWER_QUALITY_ANALYSIS_H
...
#endif /*SCREEN_POWER_QUALITY_ANALYSIS_H*/