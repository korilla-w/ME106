/**
 * @file screen_apparent_power_gen.c
...
#include "screen_apparent_power_gen.h"
...
lv_obj_t * screen_apparent_power_create(void)
{
    ...
    lv_obj_set_name_static(lv_obj_0, "screen_apparent_power_#");
    ...
    lv_label_set_text(lv_label_0, "视在功率(kVA)");
    ...
    lv_obj_t * apparent_a_power_issue = lv_image_create(page_content);
    lv_obj_set_name(apparent_a_power_issue, "apparent_a_power_issue");
    ...
    lv_obj_set_style_transform_pivot_x(apparent_a_power_issue, 0, 0);
    lv_obj_set_style_transform_pivot_y(apparent_a_power_issue, 0, 0);
    lv_obj_set_style_transform_scale_x(apparent_a_power_issue, 160, 0);
    lv_obj_set_style_transform_scale_y(apparent_a_power_issue, 160, 0);
    ...
    lv_obj_t * apparent_b_power_issue = lv_image_create(page_content);
    lv_obj_set_name(apparent_b_power_issue, "apparent_b_power_issue");
    ...
    lv_obj_set_style_transform_pivot_x(apparent_b_power_issue, 0, 0);
    lv_obj_set_style_transform_pivot_y(apparent_b_power_issue, 0, 0);
    lv_obj_set_style_transform_scale_x(apparent_b_power_issue, 160, 0);
    lv_obj_set_style_transform_scale_y(apparent_b_power_issue, 160, 0);
    ...
    lv_obj_t * apparent_c_power_issue = lv_image_create(page_content);
    lv_obj_set_name(apparent_c_power_issue, "apparent_c_power_issue");
    ...
    lv_obj_set_style_transform_pivot_x(apparent_c_power_issue, 0, 0);
    lv_obj_set_style_transform_pivot_y(apparent_c_power_issue, 0, 0);
    lv_obj_set_style_transform_scale_x(apparent_c_power_issue, 160, 0);
    lv_obj_set_style_transform_scale_y(apparent_c_power_issue, 160, 0);
    ...
    lv_obj_t * apparent_total_power_issue = lv_image_create(page_content);
    lv_obj_set_name(apparent_total_power_issue, "apparent_total_power_issue");
    ...
    lv_obj_set_style_transform_pivot_x(apparent_total_power_issue, 0, 0);
    lv_obj_set_style_transform_pivot_y(apparent_total_power_issue, 0, 0);
    lv_obj_set_style_transform_scale_x(apparent_total_power_issue, 160, 0);
    lv_obj_set_style_transform_scale_y(apparent_total_power_issue, 160, 0);
    ...
    lv_obj_t * screen_apparent_power_bottom_bar = lv_obj_create(lv_obj_0);
    lv_obj_set_name(screen_apparent_power_bottom_bar, "screen_apparent_power_bottom_bar");
    lv_obj_set_x(screen_apparent_power_bottom_bar, 0);
    lv_obj_set_y(screen_apparent_power_bottom_bar, 207);
    lv_obj_set_width(screen_apparent_power_bottom_bar, 320);
    lv_obj_set_height(screen_apparent_power_bottom_bar, 33);
    lv_obj_set_style_border_width(screen_apparent_power_bottom_bar, 0, 0);
    lv_obj_set_style_pad_all(screen_apparent_power_bottom_bar, 0, 0);
    lv_obj_set_flag(screen_apparent_power_bottom_bar, LV_OBJ_FLAG_SCROLLABLE, false);
    lv_obj_add_style(screen_apparent_power_bottom_bar, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(screen_apparent_power_bottom_bar, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(screen_apparent_power_bottom_bar, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    
    lv_obj_t * apparent_btn_settings = lv_button_create(lv_obj_0);
    lv_obj_set_name(apparent_btn_settings, "apparent_btn_settings");
    lv_obj_set_x(apparent_btn_settings, 0);
    lv_obj_set_y(apparent_btn_settings, 207);
    lv_obj_set_width(apparent_btn_settings, 79);
    lv_obj_set_height(apparent_btn_settings, 32);
    lv_obj_add_style(apparent_btn_settings, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_settings, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_settings, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_add_style(apparent_btn_settings, &me106_btn_flat_blue, 0);
    lv_obj_bind_style(apparent_btn_settings, &me106_theme_light_accent, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_settings, &me106_theme_alarm_accent, 0, &meter_theme_index, 2);
    lv_obj_t * lv_image_0 = lv_image_create(apparent_btn_settings);
    ...
    lv_obj_add_screen_create_event(apparent_btn_settings, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 120, 0);
    
    lv_obj_t * apparent_btn_reserved = lv_button_create(lv_obj_0);
    lv_obj_set_name(apparent_btn_reserved, "apparent_btn_reserved");
    lv_obj_set_x(apparent_btn_reserved, 80);
    lv_obj_set_y(apparent_btn_reserved, 207);
    lv_obj_set_width(apparent_btn_reserved, 79);
    lv_obj_set_height(apparent_btn_reserved, 32);
    lv_obj_add_style(apparent_btn_reserved, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_reserved, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_reserved, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_add_style(apparent_btn_reserved, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_reserved, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_reserved, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_t * lv_image_1 = lv_image_create(apparent_btn_reserved);
    ...
    lv_obj_add_screen_create_event(apparent_btn_reserved, LV_EVENT_CLICKED, screen_function_menu_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 120, 0);
    
    lv_obj_t * apparent_btn_prev = lv_button_create(lv_obj_0);
    lv_obj_set_name(apparent_btn_prev, "apparent_btn_prev");
    lv_obj_set_x(apparent_btn_prev, 160);
    lv_obj_set_y(apparent_btn_prev, 207);
    lv_obj_set_width(apparent_btn_prev, 79);
    lv_obj_set_height(apparent_btn_prev, 32);
    lv_obj_add_style(apparent_btn_prev, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_prev, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_prev, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_add_style(apparent_btn_prev, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_prev, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_prev, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_t * lv_image_2 = lv_image_create(apparent_btn_prev);
    ...
    lv_obj_add_screen_create_event(apparent_btn_prev, LV_EVENT_CLICKED, screen_reactive_power_create, LV_SCREEN_LOAD_ANIM_NONE, 0, 0);
    
    lv_obj_t * apparent_btn_next = lv_button_create(lv_obj_0);
    lv_obj_set_name(apparent_btn_next, "apparent_btn_next");
    lv_obj_set_x(apparent_btn_next, 240);
    lv_obj_set_y(apparent_btn_next, 207);
    lv_obj_set_width(apparent_btn_next, 80);
    lv_obj_set_height(apparent_btn_next, 32);
    lv_obj_add_style(apparent_btn_next, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_next, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_next, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_add_style(apparent_btn_next, &me106_btn_flat_gray47, 0);
    lv_obj_bind_style(apparent_btn_next, &me106_theme_light_nav, 0, &meter_theme_index, 1);
    lv_obj_bind_style(apparent_btn_next, &me106_theme_alarm_nav, 0, &meter_theme_index, 2);
    lv_obj_t * lv_image_3 = lv_image_create(apparent_btn_next);
    ...
    lv_obj_add_screen_create_event(apparent_btn_next, LV_EVENT_CLICKED, screen_energy_data_create, LV_SCREEN_LOAD_ANIM_NONE, 0, 0);
    
    
    /* create animation timeline(s) */
    lv_anim_timeline_t ** at_array = lv_malloc(sizeof(lv_anim_timeline_t *) * _SCREEN_APPARENT_POWER_TIMELINE_CNT);
    at_array[SCREEN_APPARENT_POWER_TIMELINE_CONTENT_OPEN] = timeline_content_open_create(lv_obj_0);
    lv_obj_set_user_data(lv_obj_0, at_array);
    lv_obj_add_event_cb(lv_obj_0, free_timeline_event_cb, LV_EVENT_DELETE, at_array);

    lv_obj_add_play_timeline_event(lv_obj_0, LV_EVENT_SCREEN_LOADED, screen_apparent_power_get_timeline(lv_obj_0, SCREEN_APPARENT_POWER_TIMELINE_CONTENT_OPEN), 0, false);
...
{
    if (timeline_id >= _SCREEN_APPARENT_POWER_TIMELINE_CNT) {
        LV_LOG_WARN("screen_apparent_power has no timeline with %d ID", timeline_id);
        return NULL;
    }
...
static void free_timeline_event_cb(lv_event_t * e)
{
    ...
    uint32_t i;
    for(i = 0; i < _SCREEN_APPARENT_POWER_TIMELINE_CNT; i++) {
