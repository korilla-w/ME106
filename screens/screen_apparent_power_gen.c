...
static lv_anim_timeline_t * timeline_measurement_header_open_create(lv_obj_t * obj);
...
lv_obj_t * screen_apparent_power_create(void)
{
    ...
    lv_obj_t * apparent_header = lv_obj_create(page_content);
    lv_obj_set_name(apparent_header, "apparent_header");
    lv_obj_set_x(apparent_header, 0);
    lv_obj_set_y(apparent_header, 0);
    lv_obj_set_width(apparent_header, 320);
    lv_obj_set_height(apparent_header, 44);
    lv_obj_set_style_bg_opa(apparent_header, 0, 0);
    lv_obj_set_style_border_width(apparent_header, 0, 0);
    lv_obj_set_style_pad_all(apparent_header, 0, 0);
    lv_obj_set_flag(apparent_header, LV_OBJ_FLAG_SCROLLABLE, false);
    lv_obj_t * apparent_brand_logo = lv_image_create(apparent_header);
    lv_obj_set_name(apparent_brand_logo, "apparent_brand_logo");
    lv_image_set_src(apparent_brand_logo, meter_brand_logo);
    lv_obj_set_x(apparent_brand_logo, 20);
    lv_obj_set_y(apparent_brand_logo, 17);

    lv_obj_t * lv_label_0 = lv_label_create(apparent_header);
    ...
    lv_obj_set_x(apparent_a_power_issue, 71);
    ...
    lv_obj_set_x(apparent_b_power_issue, 234);
    ...
    lv_obj_set_x(apparent_c_power_issue, 71);
    ...
    lv_obj_add_screen_create_event(apparent_btn_settings, LV_EVENT_CLICKED, screen_settings_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
    ...
    lv_obj_add_screen_create_event(apparent_btn_reserved, LV_EVENT_CLICKED, screen_function_menu_create, LV_SCREEN_LOAD_ANIM_FADE_IN, 125, 0);
    ...
    at_array[SCREEN_APPARENT_POWER_TIMELINE_MEASUREMENT_HEADER_OPEN] = timeline_measurement_header_open_create(lv_obj_0);
    lv_obj_set_user_data(lv_obj_0, at_array);
    lv_obj_add_event_cb(lv_obj_0, free_timeline_event_cb, LV_EVENT_DELETE, at_array);

    lv_obj_add_play_timeline_event(lv_obj_0, LV_EVENT_SCREEN_LOADED, screen_apparent_power_get_timeline(lv_obj_0, SCREEN_APPARENT_POWER_TIMELINE_MEASUREMENT_HEADER_OPEN), 0, false);
...
static lv_anim_timeline_t * timeline_measurement_header_open_create(lv_obj_t * obj)
{
    ...
    lv_anim_set_var(&a, lv_obj_find_by_name(obj, "apparent_header"));
